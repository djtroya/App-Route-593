...
const procesarMensaje = async (data) => {
  if (!data.cedula || !data.ubicacion || !data.urbanizacion || !data.destino || !data.mensaje || !data.phone) {
    throw new Error('Faltan parámetros: cedula, ubicacion, urbanizacion, destino, mensaje o phone');
  }
  ...
  const { error } = await supabase
    ...
    .insert([{
      ...
      numero: data.phone,  // Se utiliza "phone" en vez de "numero"
